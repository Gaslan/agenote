'use client'
import { Box, Button, Collapse, IconButton, List, ListItem, ListItemButton, ListItemIcon, ListItemText } from "@mui/material"
...
import { addTodoListSection, getTodoListSectionsByListId } from "@/db/todo-list-service";
...
export default function Page({ params }: PageProps) {
  ...
  async function fetchSections() {
    const sections = await getTodoListSectionsByListId(+params.listId)
  ...
  async function handleSectionNameSubmit(name: string) {
    await addTodoListSection(name, +params.listId)
    await fetchSections()
